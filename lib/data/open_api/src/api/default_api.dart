...
import 'package:dinolab/data/open_api/src/model/api_login_post200_response.dart';
import 'package:dinolab/data/open_api/src/model/api_login_post_request.dart';
import 'package:dinolab/data/open_api/src/model/api_me_post200_response.dart';
import 'package:dinolab/data/open_api/src/model/api_me_post401_response.dart';
import 'package:dinolab/data/open_api/src/model/api_register_post201_response.dart';
...
class DefaultApi {
  ...
  Future<Response<ApiLoginPost200Response>> apiLoginPost({
    ...
    ApiLoginPost200Response? _responseData;
    ...
    return Response<ApiLoginPost200Response>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiMePost200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiMePost200Response>> apiMeGet({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    ApiMePost200Response? _responseData;
    ...
    return Response<ApiMePost200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ApiRegisterPost201Response>> apiRegisterPost({
    ...
    ApiRegisterPost201Response? _responseData;
    ...
    return Response<ApiRegisterPost201Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
